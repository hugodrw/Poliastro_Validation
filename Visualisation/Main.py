...
class MyApp(ShowBase):
    ...
    def make_earth(self):
        ...
        # Load textures
        base_texture = self.loader.loadTexture("Assets/Textures/earth_albedo.jpg")
        gloss_texture = self.loader.loadTexture("Assets/Textures/earth_specular.jpg")
        glow_texture = self.loader.loadTexture("Assets/Textures/earth_emission.png")
    ...
    def make_sphere(self , size=1 , low_poly=False):
        path = "Assets/Models/sphere5.obj"
        if low_poly:
            path = "Assets/Models/low_poly_sphere.obj"
    ...
    def add_text_label(self , text="PlaceHolder" , pos=(-1 , 1) , scale=0.06 , alignment_mode=TextNode.ALeft):
        custom_font = self.loader.loadFont('Assets/Textures/SF-Pro.ttf')
